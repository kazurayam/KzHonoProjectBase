...
var Layout = /* @__PURE__ */ __name((props) => {
  return /* @__PURE__ */ jsxDEV("html", { children: /* @__PURE__ */ jsxDEV("body", { children: props.children }) });
}, "Layout");
var Top = /* @__PURE__ */ __name((props) => {
  return /* @__PURE__ */ jsxDEV(Layout, { children: [
    /* @__PURE__ */ jsxDEV("h1", { children: "Hello Hono!" }),
    /* @__PURE__ */ jsxDEV("ul", { children: props.messages.map((message) => {
...
app.get("/", (c) => {
  ...
  return c.html(/* @__PURE__ */ jsxDEV(Top, { messages }));
});
var src_default = app;
...
// .wrangler/tmp/bundle-p2T09e/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-p2T09e/middleware-loader.entry.ts
