...
このコードは `@hono/zod-openapi` と link://https://github.com/honojs/middleware/tree/main/packages/swagger-ui[`@hono/swagger-ui`] をimportしている。これを成功させるには`myAPIプロジェクト`の外部依存性を解決する必要がある。
